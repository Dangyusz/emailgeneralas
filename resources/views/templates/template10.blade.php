...
<style>
    .tpl-10 { max-width:920px; margin:40px auto; padding:18px; }
    .tpl-10 table { font-family:Inter, Arial, sans-serif; background:#f8fff7; border-radius:12px; padding:18px; border:2px solid #b8e6c7; max-width:600px; }
    .tpl-10 img { width:120px; height:120px; border-radius:12px; display:block; }
    .tpl-10 .card-title { font-family: 'ivypresto-display', Georgia, serif; font-size:28px; color:#1c6a48; }
    .tpl-10 .card-details { font-size:14px; color:#333; }
</style>
