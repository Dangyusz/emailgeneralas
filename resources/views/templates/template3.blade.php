<style>
    ...
    .tpl-3 .inner-wrapper {
        background: #ffffff url('https://cdn.hexaverse.hu/sarga.svg') right center / auto 185% no-repeat;
        border-radius: 20px;
        padding: 32px;
        border: 3px solid #ffe600ff;
        display: flex;
        gap: 32px;
    ...
    .tpl-3 .name-and-socials {
        display: flex;
        align-items: flex-start;
        justify-content: space-between;
        gap: 16px;
        border-bottom: 3px solid #ff8b16ff;
        padding-bottom: 8px;
    }
    .tpl-3 .name {
